        ...
        <v-row align="start">
          <v-col cols="12" md="3">
            <h4 class="text-h5 font-weight-bold">
              La Disonancia / Diario de Bolsillo
            </h4>
            <p class="text-body-1">
              Por un periodismo serio.
            </p>
          </v-col>

          <v-col cols="12" md="3">
            <v-list color="transparent" flat>
              <v-subheader class="text-h6">La Disonancia</v-subheader>
          ...
          <v-col cols="12" md="3">
            <v-list color="transparent" flat>
              <v-subheader class="text-h6">La Discordia</v-subheader>
              <v-list-item-group color="primary">
                <v-list-item
          ...
          <v-col cols="12" md="3">
            <div>
              ...
              <p class="text-body-1">
                Suscribite para recibir nuestros newsletters todos los lunes.
              </p>
            </div>
